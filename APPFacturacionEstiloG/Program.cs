...
namespace APPFacturacionEstiloG
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (seguir != "no")
            {
                try
                {
                    ...
                    Console.WriteLine("+=========================================+");
                    Console.WriteLine("|                                         |");
                    Console.WriteLine("|      KREEMO SISTEMA DE FACTURACIÓN      |");
                    Console.WriteLine("|       Elija el módulo a ingresar        |");
                    Console.WriteLine("+=========================================+");
                    Console.WriteLine("|                                         |");
                    ...
                    Console.WriteLine("| (4) Gestión de reportes                 |");
                    ...
                    if (respuestaInicio == 1)
                    {
                        ...
                        Console.WriteLine("| (5) salir del módulo clientes           |");
                        Console.WriteLine("+=========================================+");
                            ...
                            {//TODO: modificar cliente
                                ...
                                for (int i = 0; i < listaClientes.Count; i++)
                                {
                                    if (doc == listaClientes[i].documento && listaClientes[i].estado == 1)
                                    {
                                        ...
                                        Console.WriteLine("|         nombre, edad o teléfono         |");
                                        Console.WriteLine("|                                         |");
                                        Console.WriteLine("+=========================================+");
                        ...
                        else if (rtaCliente == 4)
                        {
                            ...
                            if (rtaListar == 1)
                            {
                                ...
                                Console.WriteLine("+=========================================+");
                                Console.WriteLine("|                                         |");
                                Console.WriteLine("|     Ingrese el número del documento     |");
                                Console.WriteLine("|                                         |");
                                Console.WriteLine("+=========================================+");
                                doc = int.Parse(Console.ReadLine());
                                ...
                                foreach (var client in listaClientes)
                                {
                                    if (client.documento == doc)
                                    {
                                        ...
                                        Console.WriteLine($" >Teléfono: {client.Telefono}");
                    ...
                    else if (respuestaInicio == 2)
                    {
                        ...
                        else if (rtaProductos == 4)
                        {
                            ...
                            if (rtaListar == 1)
                            {
                                ...
                                Console.WriteLine("+=========================================+");
                                Console.WriteLine("|                                         |");
                                Console.WriteLine("|        Ingrese el número del id         |");
                                Console.WriteLine("|                                         |");
                                Console.WriteLine("+=========================================+");
                                doc = int.Parse(Console.ReadLine());
                                ...
                                foreach (var product in listaProductos)
                                {
                                    ...
                                    {
                                        Console.WriteLine("+=========================================+");
                                        Console.WriteLine(" >Código producto: " + product.IdProducto);
                    ...
                    else if (respuestaInicio == 3)
                    {
                        ...
                        if (rtaFacturar == 1)
                        {
                            ...
                            while (resp)
                            {
                                ...
                                while (agregar)
                                {
                                    ...
                                    Console.WriteLine("+=========================================+");
                                    Console.WriteLine("|                                         |");
                                    Console.WriteLine("| Ingrese el código del producto comprado |");
                                    Console.WriteLine("|                                         |");
                                    Console.WriteLine("+=========================================+");
                        ...
                        else if (rtaFacturar == 2)
                        {
                            ...
                            Console.WriteLine("|                                         |");
                            Console.WriteLine("| (1) listar por código factura           |");
                            ...
                            if (rta == 1)
                            {
                                ...
                                foreach (var factura in listaFacturas)
                                {
                                    if (doc == factura.idFactura)
                                    {
                                        ...
                                        Console.WriteLine(" >Número de factura: " + factura.idFactura);
                    ...
                    else if (respuestaInicio == 4)
                    {
                        ...
                        else if (rtaReportes <= 2)
                        {
                            ...
                            Console.WriteLine(" **      en 2 Stock son        ** ");
                            Console.WriteLine("");
                            Console.WriteLine("+=========================================+");
                            Console.WriteLine("");
